...
// authenticated with that subject, and any X-Test-Roles become role claims; without the subject header
// the request is unauthenticated, so RequireAuthorization yields 401. Lets the office endpoints be
// tested without a live Keycloak or BFF.
