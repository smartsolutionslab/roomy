...
// carries an accessible "Roomy" name via a visually-hidden label. Size, corner radius and shadow are
// overridable via the --roomy-logo-size/-radius/-shadow custom properties (the hero scales it up).
@Component({
  selector: 'roomy-logo',
