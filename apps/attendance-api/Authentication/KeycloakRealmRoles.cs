...
namespace SmartSolutionsLab.Roomy.Attendance.Api.Authentication;

// Keycloak carries realm roles in a nested `realm_access.roles` array, which the JWT handler surfaces as
// a single JSON-valued claim rather than individual role claims. The admin authorization policy gates on
