...
public sealed class CompleteEmployeeProvisioningHandler(
    IEmployeeRepository employees,
    IUnitOfWork unitOfWork) : ICommandHandler<CompleteEmployeeProvisioning>
{
    public async Task<Result> HandleAsync(
        CompleteEmployeeProvisioning command,
