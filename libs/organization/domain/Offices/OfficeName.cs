...
// An office's name: required and trimmed. Equality is by value. Uniqueness within the company is a
// set-level invariant enforced by persistence (unique index) plus a handler pre-check, not here.
